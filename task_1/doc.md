## 📬 Containerizing the Mindfuel Quote Email Service

This is a simple Python service that fetches a daily quote from the ZenQuotes API and sends it via email to recipients stored in a PostgreSQL database. The service is containerized with Docker, making it easy to run anywhere.
...
```
It can be accessed via this [URL](https://hub.docker.com/r/jhoie/mindfuel-quote-service).
